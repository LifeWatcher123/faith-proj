...
questionElement1.textContent = columnContent[index].question1;
questionElement2.textContent = columnContent[index].question2;
imageElement1.src = columnContent[index].imageSrc1;
imageElement2.src = columnContent[index].imageSrc2;

// Reset user choices for the new group of questions
userChoices = [];
}
